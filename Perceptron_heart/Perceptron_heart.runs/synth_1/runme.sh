...
HD_PWD='C:/Users/Dhwanil/Desktop/fpga_2.0/Perceptron_heart/Perceptron_heart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heart_risk_minimal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heart_risk_minimal.tcl
