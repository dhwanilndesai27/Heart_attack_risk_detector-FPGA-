...
HD_PWD='C:/Users/Dhwanil/Desktop/fpga_2.0/Perceptron_heart/Perceptron_heart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log heart_risk_minimal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source heart_risk_minimal.tcl -notrace
